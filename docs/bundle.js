...
var app = (function () {
    ...
    const file$c = "src/SampleConfiguration_004.svelte";
    ...
    function create_left_slot(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			p = element("p");
    			p.textContent = "left";
    			add_location(p, file$c, 8, 2, 183);
    			attr(div, "slot", "left");
    			add_location(div, file$c, 7, 1, 163);
    		},
    ...
    function create_default_slot_5$3(ctx) {
    	...
    	return {
    		c: function create() {
    			li = element("li");
    			li.textContent = "1";
    			add_location(li, file$c, 16, 6, 315);
    		},
    ...
    function create_default_slot_4$3(ctx) {
    	...
    	return {
    		c: function create() {
    			li = element("li");
    			li.textContent = "2";
    			add_location(li, file$c, 19, 6, 358);
    		},
    ...
    function create_default_slot_3$4(ctx) {
    	...
    	return {
    		c: function create() {
    			li = element("li");
    			li.textContent = "3";
    			add_location(li, file$c, 22, 6, 398);
    		},
    ...
    function create_default_slot_2$4(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			li = element("li");
    			li.textContent = "4";
    			add_location(li, file$c, 24, 5, 426);
    			add_location(ul, file$c, 14, 4, 293);
    		},
    ...
    function create_default_slot_1$5(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(p0, file$c, 12, 3, 269);
    			add_location(p1, file$c, 27, 3, 460);
    			add_location(p2, file$c, 28, 3, 474);
    		},
    ...
    function create_center_slot$3(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			stack.$$.fragment.c();
    			attr(div, "slot", "center");
    			add_location(div, file$c, 10, 1, 204);
    		},
    ...
    function create_right_slot(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			p = element("p");
    			p.textContent = "right";
    			add_location(p, file$c, 32, 2, 528);
    			attr(div, "slot", "right");
    			add_location(div, file$c, 31, 1, 507);
    		},
    ...
    const file$d = "src/layout/Grid.svelte";
    ...
    function create_fragment$d(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(div, file$d, 22, 0, 446);
    		},
    ...
    class Grid extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$9, create_fragment$d, safe_not_equal, ["min", "space"]);
    	}
    ...
    const file$e = "src/SampleConfiguration_005.svelte";
    ...
    function create_center_slot$4(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			grid.$$.fragment.c();
    			attr(div, "slot", "center");
    			add_location(div, file$e, 7, 1, 155);
    		},
    ...
    const file$f = "src/layout/Switcher.svelte";
    ...
    function create_fragment$f(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(div, file$f, 39, 0, 1080);
    		},
    ...
    class Switcher extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$a, create_fragment$f, safe_not_equal, ["threshold", "space", "limit"]);
    	}
    ...
    const file$g = "src/SampleConfiguration_006.svelte";
    ...
    function create_center_slot$5(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			switcher.$$.fragment.c();
    			attr(div, "slot", "center");
    			add_location(div, file$g, 7, 1, 163);
    		},
    ...
    function create_fragment$h(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(main, file$h, 58, 0, 1615);
    		},
