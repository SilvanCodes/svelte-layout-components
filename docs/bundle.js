...
var app = (function () {
    ...
    function create_fragment$3(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(div, file$3, 35, 0, 850);
    		},
    ...
    function create_fragment$5(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(div, file$5, 40, 0, 1126);
    		},
    ...
    function create_sidebar_slot$1(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			attr(div, "slot", "sidebar");
    			add_location(div, file$7, 39, 3, 836);
    		},
    ...
    function create_not_sidebar_slot$1(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			attr(div, "slot", "not-sidebar");
    			add_location(div, file$7, 42, 3, 903);
    		},
    ...
    function create_fragment$7(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(div, file$7, 35, 0, 741);
    		},
    ...
    function create_header_slot(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(div, file$8, 12, 1, 335);
    		},
    ...
    function create_center_slot_4(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			p.textContent = "Sidebar Title";
    			attr(p, "slot", "center");
    			add_location(p, file$9, 15, 3, 489);
    		},
    ...
    function create_center_slot_3$2(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			stack.$$.fragment.c();
    			attr(div, "slot", "center");
    			add_location(div, file$9, 18, 3, 568);
    		},
    ...
    function create_sidebar_slot$3(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			set_style(div, "background", "var(--color-secondary)");
    			set_style(div, "color", "white");
    			add_location(div, file$9, 13, 1, 379);
    		},
    ...
    function create_not_sidebar_slot$3(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			cover.$$.fragment.c();
    			attr(div, "slot", "not-sidebar");
    			add_location(div, file$9, 28, 1, 796);
    		},
    ...
    const file$a = "src/layout/Box.svelte";
    ...
    function create_fragment$a(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(div, file$a, 32, 0, 1228);
    		},
    ...
    class Box extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$7, create_fragment$a, safe_not_equal, ["padding", "color", "backgroundColor", "borderWidth", "borderStyle", "borderColor"]);
    	}
    ...
    const file$c = "src/layout/Cluster.svelte";
    ...
    class Cluster extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$8, create_fragment$c, safe_not_equal, ["justify", "align", "space"]);
    	}
    ...
    const file$d = "src/SampleConfiguration_005.svelte";

    // (12:4) <Cluster>
    function create_default_slot_2$5(ctx) {
    	var ul, li0, t1, li1, t3, li2, t5, li3, t7, li4, t9, li5, t11, li6, t13, li7;
    	...
    	return {
    		c: function create() {
    			...
    			li7 = element("li");
    			li7.textContent = "H";
    			add_location(li0, file$d, 13, 6, 295);
    			add_location(li1, file$d, 14, 6, 312);
    			add_location(li2, file$d, 15, 6, 329);
    			add_location(li3, file$d, 16, 6, 346);
    			add_location(li4, file$d, 17, 6, 363);
    			add_location(li5, file$d, 18, 6, 380);
    			add_location(li6, file$d, 19, 6, 397);
    			add_location(li7, file$d, 20, 6, 414);
    			add_location(ul, file$d, 12, 5, 284);
    		},
    ...
    // (10:3) <div slot="center">
    function create_center_slot_1$3(ctx) {
    	var div, p, t_1, current;
    	...
    	return {
    		c: function create() {
    			div = element("div");
    			p = element("p");
    			p.textContent = "WIDE CONTENT";
    			t_1 = space();
    			cluster.$$.fragment.c();
    			add_location(p, file$d, 10, 4, 245);
    			attr(div, "slot", "center");
    			add_location(div, file$d, 9, 3, 221);
    		},
    ...
    function create_center_slot$5(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			bracket.$$.fragment.c();
    			attr(div, "slot", "center");
    			add_location(div, file$d, 7, 1, 169);
    		},
