    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			attr(div0, "class", "sidebar svelte-18xwqnp");
    			add_location(div0, file, 36, 8, 883);

    			attr(div1, "class", div1_class_value = "" + (`not-sidebar${ctx.scale}`) + " svelte-18xwqnp");
    			add_location(div1, file, 39, 8, 970);
    			attr(div2, "class", "svelte-18xwqnp");
    			add_location(div2, file, 35, 4, 869);
    			attr(div3, "class", div3_class_value = "" + (`with-sidebar${ctx.scale}`) + " svelte-18xwqnp");
    			add_location(div3, file, 34, 0, 828);
    		},
    		...
    		p: function update(changed, ctx) {
    			...
    			if ((!current || changed.scale) && div1_class_value !== (div1_class_value = "" + (`not-sidebar${ctx.scale}`) + " svelte-18xwqnp")) {
    				attr(div1, "class", div1_class_value);
    			}

    			if ((!current || changed.scale) && div3_class_value !== (div3_class_value = "" + (`with-sidebar${ctx.scale}`) + " svelte-18xwqnp")) {
