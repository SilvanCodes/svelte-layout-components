...
var app = (function () {
    ...
    function create_else_block(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(div0, file, 59, 12, 1696);

    			attr(div1, "class", "sidebar svelte-c4ub5i");
    			add_location(div1, file, 62, 12, 1802);
    		},
    ...
    function create_if_block(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(div0, file, 52, 12, 1476);

    			attr(div1, "class", "not-sidebar svelte-c4ub5i");
    			add_location(div1, file, 55, 12, 1574);
    		},
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(div0, file, 50, 4, 1428);
    			attr(div1, "class", "" + ctx.id + " svelte-c4ub5i");
    			add_location(div1, file, 49, 0, 1407);
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(div0, file$1, 42, 4, 1053);

    			attr(div1, "class", "center svelte-e60axm");
    			add_location(div1, file$1, 45, 4, 1123);

    			attr(div2, "class", "below svelte-e60axm");
    			add_location(div2, file$1, 48, 4, 1195);
    			attr(div3, "class", "" + ctx.id + " svelte-e60axm");
    			add_location(div3, file$1, 41, 0, 1032);
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(div0, file$2, 51, 4, 1433);

    			attr(div1, "class", "center svelte-1mln3ll");
    			add_location(div1, file$2, 54, 4, 1501);

    			attr(div2, "class", "right svelte-1mln3ll");
    			add_location(div2, file$2, 57, 4, 1573);
    			attr(div3, "class", "" + ctx.id + " svelte-1mln3ll");
    			add_location(div3, file$2, 50, 0, 1412);
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
        ...
        let { maxWidth = 'measure', andText = false, space = 's0', padding = 's0', intrinsic = false } = $$props;
    ...
    class Bracket extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, ["maxWidth", "andText", "space", "padding", "intrinsic"]);
    	}
    ...
    function create_fragment$3(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(div, file$3, 33, 0, 1246);
    		},
    ...
    function create_fragment$4(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(div, file$4, 37, 0, 972);
    		},
    ...
    function create_default_slot_3(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			p = element("p");
    			t = space();
    			add_location(p, file$6, 20, 28, 677);
    			add_location(div, file$6, 19, 24, 643);
    		},
    ...
    function create_default_slot_2(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			p = element("p");
    			t = space();
    			add_location(p, file$6, 14, 28, 448);
    			add_location(div, file$6, 13, 24, 414);
    		},
    ...
    function create_center_slot_3(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			attr(h1, "slot", "center");
    			add_location(h1, file$8, 15, 3, 396);
    		},
    ...
    function create_above_slot(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			bracket.$$.fragment.c();
    			attr(div, "slot", "above");
    			add_location(div, file$8, 13, 1, 362);
    		},
    ...
    function create_default_slot_4(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			t3 = space();
    			button2.$$.fragment.c();
    			add_location(p, file$8, 24, 7, 597);
    		},
    ...
    function create_center_slot_2(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(div, file$8, 22, 5, 556);
    		},
    ...
    function create_sidebar_slot(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(div, file$8, 20, 3, 502);
    		},
    ...
    function create_not_sidebar_slot(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(div, file$8, 32, 3, 772);
    		},
    ...
    function create_center_slot_1(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			sidebar.$$.fragment.c();
    			attr(div, "slot", "center");
    			add_location(div, file$8, 18, 1, 450);
    		},
    ...
    function create_center_slot(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			attr(p, "slot", "center");
    			add_location(p, file$8, 39, 3, 904);
    		},
    ...
    function create_below_slot(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			bracket.$$.fragment.c();
    			attr(div, "slot", "below");
    			add_location(div, file$8, 37, 1, 870);
    		},
    ...
    const file$9 = "src/layout/Frame.svelte";
    ...
    function create_fragment$9(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(div, file$9, 38, 0, 808);
    		},
    ...
    class Frame extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$8, create_fragment$9, safe_not_equal, ["n", "d"]);
    	}
    ...
    function create_left_slot(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			p = element("p");
    			p.textContent = "left";
    			add_location(p, file$a, 9, 2, 227);
    			attr(div, "slot", "left");
    			add_location(div, file$a, 8, 1, 207);
    		},
    ...
    function create_default_slot_5$1(ctx) {
    	...
    	return {
    		c: function create() {
    			li = element("li");
    			li.textContent = "1";
    			add_location(li, file$a, 17, 6, 359);
    		},
    ...
    function create_default_slot_4$1(ctx) {
    	...
    	return {
    		c: function create() {
    			li = element("li");
    			li.textContent = "2";
    			add_location(li, file$a, 20, 6, 402);
    		},
    ...
    function create_default_slot_3$2(ctx) {
    	...
    	return {
    		c: function create() {
    			li = element("li");
    			li.textContent = "3";
    			add_location(li, file$a, 23, 6, 442);
    		},
    ...
    function create_default_slot_2$2(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			li = element("li");
    			li.textContent = "4";
    			add_location(li, file$a, 25, 5, 470);
    			add_location(ul, file$a, 15, 4, 337);
    		},
    ...
    function create_default_slot_1$2(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(p0, file$a, 13, 3, 313);
    			add_location(p1, file$a, 28, 3, 504);
    			add_location(p2, file$a, 29, 3, 518);
    		},
    ...
    function create_center_slot$1(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			stack.$$.fragment.c();
    			attr(div, "slot", "center");
    			add_location(div, file$a, 11, 1, 248);
    		},
    ...
    function create_right_slot(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			p = element("p");
    			p.textContent = "right";
    			add_location(p, file$a, 33, 2, 572);
    			attr(div, "slot", "right");
    			add_location(div, file$a, 32, 1, 551);
    		},
    ...
    const file$b = "src/layout/Grid.svelte";
    ...
    function create_fragment$b(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(div, file$b, 23, 0, 518);
    		},
    ...
    class Grid extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$9, create_fragment$b, safe_not_equal, ["min", "space"]);
    	}
    ...
    const file$c = "src/SampleConfiguration_003.svelte";
    ...
    function create_center_slot$2(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			grid.$$.fragment.c();
    			attr(div, "slot", "center");
    			add_location(div, file$c, 7, 1, 155);
    		},
    ...
    const file$d = "src/layout/Switcher.svelte";
    ...
    function create_fragment$d(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(div0, file$d, 38, 4, 1171);
    			attr(div1, "class", ctx.id);
    			add_location(div1, file$d, 37, 0, 1150);
    		},
    ...
    class Switcher extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$a, create_fragment$d, safe_not_equal, ["threshold", "space", "limit"]);
    	}
    ...
    const file$e = "src/layout/Reel.svelte";
    ...
    function create_fragment$e(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(div, file$e, 33, 0, 843);
    		},
    ...
    class Reel extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$b, create_fragment$e, safe_not_equal, ["itemWidth", "space", "height"]);
    	}
    ...
    const file$f = "src/SampleConfiguration_004.svelte";
    ...
    function create_above_slot$1(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			reel.$$.fragment.c();
    			attr(div, "slot", "above");
    			add_location(div, file$f, 8, 1, 205);
    		},
    ...
    function create_center_slot$3(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			box.$$.fragment.c();
    			attr(div, "slot", "center");
    			add_location(div, file$f, 37, 1, 1292);
    		},
    ...
    const file$g = "src/SampleConfiguration_005.svelte";
    ...
    function create_default_slot_1$5(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(img, file$g, 9, 2, 213);
    		},
    ...
    function create_fragment$h(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(main, file$h, 57, 0, 1548);
    		},
